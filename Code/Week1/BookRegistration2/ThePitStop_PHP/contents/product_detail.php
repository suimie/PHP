...
//$related_product = get_products_withlimit(array($product['CategoryId']), 3);
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="gallery" style="height:385px;background-color:rgb(255,255,255);">
                                <img src="<?php echo get_product_image_src($product['CategoryId'], $product['pId'], $product['imageType']); ?>" width="100px" height="350px" style="width:350px;margin-left:10px;">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info">
                                ...
                                <div class="rating"><img src="assets/img/star.svg">
                                    <img src="assets/img/star.svg"><img src="assets/img/star.svg"><img src="assets/img/star-half-empty.svg"><img src="assets/img/star-empty.svg">
                                </div>
                                <div class="price">
